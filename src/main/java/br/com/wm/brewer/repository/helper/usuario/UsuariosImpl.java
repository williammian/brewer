...
import br.com.wm.brewer.model.Grupo;
import br.com.wm.brewer.model.Usuario;
import br.com.wm.brewer.model.UsuarioGrupo;
...
public class UsuariosImpl implements UsuariosQueries {
	...
	public Page<Usuario> filtrar(UsuarioFilter filtro, Pageable pageable) {
		...
		//criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY); //distinct (antes de ter paginação)
	...
	private void adicionarFiltro(UsuarioFilter filtro, Criteria criteria) {
		if (filtro != null) {
			...
			//criteria.createAlias("grupos", "g", JoinType.LEFT_OUTER_JOIN); //join para incializar os grupos na mesma consulta (antes de ter paginação)
